...
$product_categories = array(
    array(
        ...
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="-2 -2 28 28" preserveAspectRatio="xMidYMid meet" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 21h18M3 7v1a3 3 0 0 0 3 3h1m0-4v4m0 0v11m0-11h5m0 0v11m0-11v-4l3 3m-3-3l3-3m2 18v-8a2 2 0 0 1 2-2h1"/></svg>',
    ...
    array(
        ...
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="-2 -2 28 28" preserveAspectRatio="xMidYMid meet" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>',
    ...
    array(
        ...
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="-2 -2 28 28" preserveAspectRatio="xMidYMid meet" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="7" cy="17" r="4"/><path d="M11 17h4m4 0a4 4 0 0 1-4-4V7m0 0V5a2 2 0 0 1 2-2h2m-4 2h4"/></svg>',
    ...
    array(
        ...
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="-2 -2 28 28" preserveAspectRatio="xMidYMid meet" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 6.5V8m0 8v1.5m4.5-4.5H18m-12 0H4.5M7.757 7.757l-.707-.707m9.9 9.9l.707.707m0-9.9l.707-.707m-9.9 9.9l-.707.707M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/></svg>',
